...
public class UpdateInterpreterTest extends BaseDroolsAccessControlTest {
    ...
    private static final String UPDATE_COURT_INTERPRETER_COMMAND_NAME = "sjp.update-interpreter";
    ...
    public void shouldAllowUserInAuthorisedGroup() {
        ...
        given(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getUpdateInterpreterGroups())).willReturn(true);
