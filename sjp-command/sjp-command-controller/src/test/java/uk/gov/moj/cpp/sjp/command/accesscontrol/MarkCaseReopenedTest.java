...
public class MarkCaseReopenedTest extends BaseDroolsAccessControlTest {
    ...
    @Test
    public void shouldAllowMarkCaseReopenedInLibraCommand() {
        final JsonObject inputPayload = createObjectBuilder()
                .add("caseId", randomUUID().toString())
                .build();
        final JsonEnvelope envelope = JsonEnvelopeBuilder.envelopeFrom(metadataWithRandomUUID("sjp.command.mark-case-reopened-in-libra").build(), inputPayload);
