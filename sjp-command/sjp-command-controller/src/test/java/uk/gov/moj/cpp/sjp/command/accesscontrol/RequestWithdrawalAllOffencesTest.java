...
public class RequestWithdrawalAllOffencesTest extends BaseDroolsAccessControlTest {
    ...
    @Test
    public void shouldAllowRequestWithdrawalAllOffencesCommand() {
        final JsonObject inputPayload = createObjectBuilder()
                .add("caseId", randomUUID().toString())
                .build();
        final JsonEnvelope envelope = JsonEnvelopeBuilder.envelopeFrom(metadataWithRandomUUID("sjp.command.request-withdrawal-all-offences").build(), inputPayload);
