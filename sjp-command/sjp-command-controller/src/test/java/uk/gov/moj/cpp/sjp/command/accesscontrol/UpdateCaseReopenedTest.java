...
public class UpdateCaseReopenedTest extends BaseDroolsAccessControlTest {
    ...
    @Test
    public void shouldAllowUpdateCaseReopenedInLibraCommand() {
        final JsonObject inputPayload = createObjectBuilder()
                .add("caseId", randomUUID().toString())
                .build();
        final JsonEnvelope envelope = envelopeFrom(metadataWithRandomUUID("sjp.command.update-case-reopened-in-libra").build(), inputPayload);
