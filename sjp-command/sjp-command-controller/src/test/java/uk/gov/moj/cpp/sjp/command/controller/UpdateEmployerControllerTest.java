...
import uk.gov.moj.cpp.sjp.command.controller.UpdateEmployerController;
...
public class UpdateEmployerControllerTest {
    ...
    @InjectMocks
    private UpdateEmployerController updateEmployerController;
    ...
    private JsonEnvelope getUpdateEmployerCommand(final UUID caseId) {
        final JsonObject payload = Json.createObjectBuilder()
                ...
                .build();
        return createEnvelope("sjp.command.update-employer", payload);
    }
