...
public class UpdatePleaControllerTest {
    ...
    private static final String SJP_COMMAND_PLEA_UPDATE = "sjp.command.update-plea";
    private static final String SJP_CPS_PLEA_UPDATE = "sjp.cps.update-plea";
    ...
    public void shouldRejectCaseUpdateWhenCaseAssigned() {
        ...
        assertThat(captor.getValue(), jsonEnvelope(
                metadata().withName(SJP_COMMAND_CASE_UPDATE_REJECTED),
    ...
    public void shouldHaveAnnotationWithProperActionName() throws NoSuchMethodException {
        ...
        assertEquals(SJP_COMMAND_PLEA_UPDATE, annotation.value());
    }
    ...
    private JsonEnvelope getCommandEnvelope(boolean cancel) {
        ...
        return createEnvelope(SJP_COMMAND_PLEA_UPDATE, builder.build());
    }
    ...
    private JsonEnvelope getCpsUpdatePleaCommandEnvelope() {
        final JsonObject payload = Json.createObjectBuilder()
                .add("caseId", CASE_ID.toString())
                .build();
        return createEnvelope(SJP_CPS_PLEA_UPDATE, payload);
    }
}