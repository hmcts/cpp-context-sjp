...
public class AcceptPendingDefendantChangesHandlerCC extends BasePersonInfoHandler {
    @Inject
    ...
    @Handles("sjp.command.accept-pending-defendant-changes-from-CC")
    public void acceptPendingDefendantChangesFromCC(final JsonEnvelope command) throws EventStreamException {
        ...
        final Stream<Object> events = caseAggregate.acceptPendingDefendantChangesCC(caseId, defendantId, person, createdAt);
