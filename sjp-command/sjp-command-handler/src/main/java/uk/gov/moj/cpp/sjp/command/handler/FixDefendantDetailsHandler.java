...
public class FixDefendantDetailsHandler extends BasePersonInfoHandler {
    ...
    public void fixDefendantDetails(final JsonEnvelope command) throws EventStreamException {
        ...
        final Stream<Object> events = caseAggregate.fixDefendantDetails(caseId, personId, gender,
