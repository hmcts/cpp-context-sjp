...
public class AocpAcceptedEmailNotificationHandlerTest {
    ...
    public void shouldRequestEmailQueuedNotification() throws EventStreamException {
        final ZonedDateTime queuedTime = ZonedDateTime.now(ZoneOffset.UTC);
                ...
                streamContaining(
                        jsonEnvelope(
                                ...
                                payloadIsJson(allOf(
                                        ...
                                        withJsonPath("$.queuedTime", equalTo(queuedTime.toLocalDateTime().truncatedTo(ChronoUnit.MILLIS) + "Z"))
                                ))))));
    }
