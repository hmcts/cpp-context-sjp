...
public class SessionRulesTest {
    ...
    public void shouldGetMagistrateSession() {
        assertThat(getSessionType(PIA, NOT_ADJOURNED_POST_CONVICTION, false), is(MAGISTRATE));
        assertThat(getSessionType(PLEADED_GUILTY, NOT_ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(PIA, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(PLEADED_GUILTY, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(PLEADED_NOT_GUILTY, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(PLEADED_GUILTY_REQUEST_HEARING, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(WITHDRAWAL_REQUESTED, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(UNKNOWN, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(DEFAULT_STATUS, ADJOURNED_POST_CONVICTION,false), is(MAGISTRATE));
        assertThat(getSessionType(DEFAULT_STATUS, NOT_ADJOURNED_POST_CONVICTION, true), is(MAGISTRATE));
    }

    @Test
    public void shouldGetDelegatedPowersSessionType() {
        assertThat(getSessionType(PLEADED_NOT_GUILTY, NOT_ADJOURNED_POST_CONVICTION,false), is(DELEGATED_POWERS));
        assertThat(getSessionType(PLEADED_GUILTY_REQUEST_HEARING, NOT_ADJOURNED_POST_CONVICTION,false), is(DELEGATED_POWERS));
        assertThat(getSessionType(WITHDRAWAL_REQUESTED, NOT_ADJOURNED_POST_CONVICTION,false), is(DELEGATED_POWERS));
        assertThat(getSessionType(UNKNOWN, NOT_ADJOURNED_POST_CONVICTION,false), is(DELEGATED_POWERS));
        assertThat(getSessionType(DEFAULT_STATUS, NOT_ADJOURNED_POST_CONVICTION,false), is(DELEGATED_POWERS));
    }
