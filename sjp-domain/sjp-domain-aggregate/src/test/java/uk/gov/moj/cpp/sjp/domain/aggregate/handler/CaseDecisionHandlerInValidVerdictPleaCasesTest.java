...
public class CaseDecisionHandlerInValidVerdictPleaCasesTest {
    ...
    public void test() {
        ...
        final List<OffenceDecision> offenceDecisions = newArrayList(new ReferForCourtHearing(UUID.randomUUID(), newArrayList(OffenceDecisionInformation.createOffenceDecisionInformation(offenceId1, verdictType)), referralReasonId, "note", 0, courtOptions));
