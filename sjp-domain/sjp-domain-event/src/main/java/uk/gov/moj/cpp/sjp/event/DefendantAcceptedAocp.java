...
import static uk.gov.moj.cpp.sjp.event.DefendantAcceptedAocp.EVENT_NAME;
...
@Event(EVENT_NAME)
public class DefendantAcceptedAocp {
    public static final String EVENT_NAME = "sjp.events.defendant-accepted-aocp";
    ...
    @JsonCreator
    public DefendantAcceptedAocp(@JsonProperty("caseId") final UUID caseId,
