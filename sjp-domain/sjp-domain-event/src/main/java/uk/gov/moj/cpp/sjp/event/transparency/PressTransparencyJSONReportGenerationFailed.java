...
@Event(EVENT_NAME)
public class PressTransparencyJSONReportGenerationFailed {

    public static final String EVENT_NAME = "sjp.events.press-transparency-json-report-generation-failed";
    private final UUID pressTransparencyReportId;

    @JsonCreator
    public PressTransparencyJSONReportGenerationFailed(@JsonProperty("pressTransparencyReportId") final UUID pressTransparencyReportId) {
