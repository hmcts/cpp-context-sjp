...
@Event(EVENT_NAME)
public class PressTransparencyPDFReportGenerationFailed {

    public static final String EVENT_NAME = "sjp.events.press-transparency-pdf-report-generation-failed";
    ...
    @JsonCreator
    public PressTransparencyPDFReportGenerationFailed(@JsonProperty("pressTransparencyReportId") final UUID pressTransparencyReportId) {
