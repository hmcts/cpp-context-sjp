...
@Event(PressTransparencyPDFReportRequested.EVENT_NAME)
public class PressTransparencyPDFReportRequested {
    public static final String EVENT_NAME = "sjp.events.press-transparency-pdf-report-requested";
    ...
    @JsonCreator
    public PressTransparencyPDFReportRequested(
