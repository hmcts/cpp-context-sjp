...
@Event(EVENT_NAME)
public class TransparencyJSONReportGenerationFailed {

    public static final String EVENT_NAME = "sjp.events.transparency-json-report-generation-failed";
    ...
    @JsonCreator
    public TransparencyJSONReportGenerationFailed(@JsonProperty("transparencyReportId") final UUID transparencyReportId,
