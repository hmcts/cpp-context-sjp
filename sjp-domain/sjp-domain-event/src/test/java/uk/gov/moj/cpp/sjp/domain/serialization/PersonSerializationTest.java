...
public class PersonSerializationTest extends AbstractSerializationTest<Person> {
    ...
    private static final Person FULL_DEFENDANT_BASE = new Person(
            ...
            "london","legalEntityName");

    private static final String EXPECTED_FULL_PERSON_SERIALIZATION = "{\"title\":\"Mr\",\"firstName\":\"Fred\",\"lastName\":\"Smith\",\"dateOfBirth\":\"1965-12-27\",\"gender\":\"Male\",\"nationalInsuranceNumber\":\"nin\",\"driverNumber\":\"TESTY708166G99KZ\",\"driverLicenceDetails\":\"driverLicenceDetails\",\"address\":{\"address1\":\"Flat 1\",\"address2\":\"1 Old Road\",\"address3\":\"London\",\"address4\":\"United Kingdom\",\"address5\":\"UK\",\"postcode\":\"SW99 1AA\"},\"contactDetails\":{\"home\":\"home\",\"mobile\":\"mobile\",\"business\":\"business\",\"email\":\"email1@abc.com\",\"email2\":\"email2@abc.com\"},\"region\":\"london\",\"legalEntityName\":\"legalEntityName\"}";

    @Override
    protected Map<Person, Matcher<String>> getParams() {
        return ImmutableMap.of(
                FULL_DEFENDANT_BASE, equalTo(EXPECTED_FULL_PERSON_SERIALIZATION));
    }
