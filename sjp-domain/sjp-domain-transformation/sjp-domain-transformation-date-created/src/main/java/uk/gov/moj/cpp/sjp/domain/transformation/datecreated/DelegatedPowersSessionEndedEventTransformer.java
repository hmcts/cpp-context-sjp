...
@Transformation
public class DelegatedPowersSessionEndedEventTransformer extends BaseEventTransformer {

    private static final Logger LOGGER
            = LoggerFactory.getLogger(DelegatedPowersSessionEndedEventTransformer.class);

    private static final String ENDED_AT = "endedAt";

    @Override
    String getEventName() {
        return "sjp.events.delegated-powers-session-ended";
    }
