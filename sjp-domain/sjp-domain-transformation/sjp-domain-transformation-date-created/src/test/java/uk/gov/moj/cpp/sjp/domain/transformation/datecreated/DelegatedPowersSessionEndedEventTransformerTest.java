...
public class DelegatedPowersSessionEndedEventTransformerTest {

    private static final String EVENT_DELEGATED_POWERS_SESSION_ENDED = "sjp.events.delegated-powers-session-ended";
    ...
    @InjectMocks
    private DelegatedPowersSessionEndedEventTransformer delegatedPowersSessionEndedEventTransformer;

    @Before
    public void setUp() {
        delegatedPowersSessionEndedEventTransformer.setEnveloper(createEnveloper());
    }
    ...
    public void shouldIgnoreIrrelevantEvents() {
        ...
        final Action action = delegatedPowersSessionEndedEventTransformer.actionFor(jsonEnvelope);
    ...
    public void shouldIgnoreEventsWithOutsideTransformationDate() {
        final JsonEnvelope jsonEnvelope = envelopeFrom(
                metadataWithRandomUUID(EVENT_DELEGATED_POWERS_SESSION_ENDED)
    ...
    @Test
    public void shouldTransformDelegatedPowersSessionEndedEvent() {
        final JsonEnvelope jsonEnvelope = envelopeFrom(
                metadataWithRandomUUID(EVENT_DELEGATED_POWERS_SESSION_ENDED)
                        .createdAt(ZonedDateTime.of(EVENT_TRANSFORMATION_DATE_TO_BE_FIXED, UTC)),
                Json.createObjectBuilder().build());
    ...
    public void shouldUpdateDateCreatedWithEventEndDate() {
        ...
        final Stream<JsonEnvelope> jsonEnvelopeStream
                = delegatedPowersSessionEndedEventTransformer.apply(originalEvent);
    ...
    private JsonEnvelope buildEnvelope() {
        ...
        return envelopeFrom(metadataWithRandomUUID(EVENT_DELEGATED_POWERS_SESSION_ENDED), payload);
    }
}
