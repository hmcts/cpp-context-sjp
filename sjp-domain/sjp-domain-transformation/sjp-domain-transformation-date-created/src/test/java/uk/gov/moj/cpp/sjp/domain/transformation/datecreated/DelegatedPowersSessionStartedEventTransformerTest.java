...
public class DelegatedPowersSessionStartedEventTransformerTest {
    ...
    public void shouldIgnoreIrrelevantEvents() {
        ...
        final Action action = delegatedPowersSessionStartedEventTransformer.actionFor(jsonEnvelope);
    ...
    public void shouldIgnoreEventsWithOutsideTransformationDate() {
        final JsonEnvelope jsonEnvelope = envelopeFrom(
                metadataWithRandomUUID(EVENT_DELEGATED_POWERS_SESSION_STARTED)
    ...
    public void shouldUpdateDateCreatedWithEventStartDate() {
        ...
        final Stream<JsonEnvelope> jsonEnvelopeStream
                = delegatedPowersSessionStartedEventTransformer.apply(originalEvent);
