...
TRANSFORMATION_JAR=`echo target/sjp-domain-transformation-defendant-updated-date-*.jar`
...
[[ ! -f ${EVENT_TOOL_JAR} ]] && \
    curl https://libraries-internal.mdv.cpp.nonlive/artifactory/repocentral/uk/gov/justice/event-tool/${EVENT_TOOL_VERSION}/event-tool-${EVENT_TOOL_VERSION}-swarm.jar -k > ${EVENT_TOOL_JAR}
