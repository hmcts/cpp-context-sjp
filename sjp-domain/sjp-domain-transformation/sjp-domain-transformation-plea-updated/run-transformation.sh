...
TRANSFORMATION_JAR=`echo target/sjp-domain-transformation-plea-updated-*.jar`
...
[[ ! -f ${EVENT_TOOL_JAR} ]] && \
    curl http://10.124.22.24:8081/artifactory/repocentral/uk/gov/justice/event-tool/${EVENT_TOOL_VERSION}/event-tool-${EVENT_TOOL_VERSION}-swarm.jar --proxy http://10.224.23.8:3128 > ${EVENT_TOOL_JAR}
