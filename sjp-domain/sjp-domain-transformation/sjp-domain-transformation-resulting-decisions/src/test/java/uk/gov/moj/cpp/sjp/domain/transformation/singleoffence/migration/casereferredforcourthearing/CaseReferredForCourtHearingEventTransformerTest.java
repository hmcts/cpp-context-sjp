...
public class CaseReferredForCourtHearingEventTransformerTest {
    ...
    @Before
    public void setup() {
        caseReferredForCourtHearingEventTransformer = new CaseReferredForCourtHearingEventTransformer(resultingService);
    ...
    public void shouldSkipMigrationOfEventIfNoResultingEventFound() {
        ...
        when(resultingService.getReferencedDecisionSavedEventByCaseId(caseId.toString())).thenReturn(null);
    ...
    private void shouldSuccessfullyTransformCaseReferredForCourtHearingEvent(String currentVerdict, VerdictType expectedVerdict) {
        ...
        when(resultingService.getReferencedDecisionSavedEventByCaseId(caseId.toString())).thenReturn(referenceDecisionSavedResult);
