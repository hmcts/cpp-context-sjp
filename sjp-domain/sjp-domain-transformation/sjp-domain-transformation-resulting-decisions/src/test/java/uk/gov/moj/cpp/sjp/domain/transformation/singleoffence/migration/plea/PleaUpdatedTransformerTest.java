...
public class PleaUpdatedTransformerTest {
    ...
    private static final String DEFENDANT_ID = "d4ec3a35-76bf-4649-b43a-761e71c3765e";
    ...
    public void setUp() throws SQLException {
        ...
        SjpViewStoreService sjpViewStoreService = new SjpViewStoreService(connectionProvider);
    ...
    public void shouldTransformPleaUpdatedWhenThePleaTypeIsGuilty() throws SQLException {
        ...
        when(idMappingCache.getId(anyString(), anyString())).thenReturn(OFFENCE_ID);
