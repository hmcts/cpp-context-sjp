...
public class CaseReferredForCourtHearingEventTransformer implements EventTransformation {
    ...
    public CaseReferredForCourtHearingEventTransformer() {
        this.resultingEventStoreRepository = ResultingEventStoreRepository.getInstance();
    }

    @VisibleForTesting
    public CaseReferredForCourtHearingEventTransformer(final ResultingEventStoreRepository resultingEventStoreRepository ) {
        this.resultingEventStoreRepository = resultingEventStoreRepository;
    }
    ...
    public Stream<JsonEnvelope> apply(JsonEnvelope existingEvent) {
        ...
        ReferenceDecisionSavedResult referenceDecisionSavedResult = resultingEventStoreRepository.getReferencedDecisionSavedEventByCaseId(caseId);
