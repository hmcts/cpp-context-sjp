...
public class WithdrawOffenceDecisionTransformerTest {
    ...
    @Mock
    private SjpViewStoreService sjpDBService;
    ...
    @Test
    public void shouldTransformTheEventAllOffencesWithdrawalRequested() {
        // given
        when(sjpDBService.getOffenceId("c4ec3a35-76bf-4649-b43a-761e71c3765e"))
                .thenReturn(Optional.of("k4ec3a35-76bf-4649-b43a-761e71c3765k"));
    ...
    @Test
    public void shouldTransformTheEventAllOffencesWithdrawalRequestCancelled() {
        // given
        when(sjpDBService.getOffenceId("d4ec3a35-76bf-4649-b43a-761e71c3765e"))
                .thenReturn(Optional.of("k4ec3a35-76bf-4649-b43a-761e71c3765e"));
