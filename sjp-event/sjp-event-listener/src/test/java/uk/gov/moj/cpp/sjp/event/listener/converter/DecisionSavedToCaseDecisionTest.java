...
public class DecisionSavedToCaseDecisionTest {
    ...
    private ReferForCourtHearing referToCourtHearing(final PressRestriction pressRestriction) {
        return new ReferForCourtHearing(randomUUID(), asList(createOffenceDecisionInformation(randomUUID(), PROVED_SJP)), randomUUID(), "Listing notes", 30, null, pressRestriction);
    }
