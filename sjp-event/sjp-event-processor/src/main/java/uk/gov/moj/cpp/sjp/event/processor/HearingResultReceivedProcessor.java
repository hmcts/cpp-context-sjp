...
public class HearingResultReceivedProcessor {

    private static final Logger LOGGER = LoggerFactory.getLogger(HearingResultReceivedProcessor.class);
    ...
    @Handles(PUBLIC_HEARING_RESULTED)
    public void hearingResultReceived(final JsonEnvelope jsonEnvelope) {

        final PublicHearingResulted publicHearingResulted = jsonObjectConverter.convert(jsonEnvelope.payloadAsJsonObject(), PublicHearingResulted.class);
        ...
        LOGGER.info("public.hearing.resulted processing start");
