...
public class CaseDocumentTypeHelper {
    ...
    /**
     * Maps SJP document types to Reference Data DocumentTypeAccess document types
     * @see uk.gov.moj.cpp.sjp.event.processor.service.ReferenceDataService#getDocumentTypeAccess(LocalDate, JsonEnvelope)
     */
