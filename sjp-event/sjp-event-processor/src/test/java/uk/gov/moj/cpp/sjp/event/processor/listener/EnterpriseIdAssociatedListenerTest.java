...
import uk.gov.moj.cpp.sjp.event.processor.listener.EnterpriseIdAssociatedListener;
...
public class EnterpriseIdAssociatedListenerTest {
    ...
    private static final String PRIVATE_EVENT_NAME = "structure.events.enterprise-id-associated";
    ...
    @InjectMocks
    private EnterpriseIdAssociatedListener listener;
