...
public class ResultingToResultsConverterHelper {
    ...
    private static final Envelope emptyEnvelope = createEnvelope("...", createObjectBuilder().build());
    ...
    public static Envelope<CaseResults> getCaseResults(final UUID resultDefinitionId1, final UUID resultDefinitionId2) {
        ...
        for (final Prompt prompt : prompts) {
            promptsBuilder.add(createObjectBuilder().add("id", prompt.getPromptDefinitionId().toString()).add("value", prompt.getValue()));
        }
