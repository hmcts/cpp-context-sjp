...
public class TransparencyReportIT extends BaseIntegrationTest {
    ...
    private static final String SJP_EVENTS_TRANSPARENCY_REPORT_REQUESTED = "sjp.events.transparency-pdf-report-requested";
    private static final String SJP_EVENTS_TRANSPARENCY_REPORT_REQUESTED_JSON = "sjp.events.transparency-json-report-requested";
    private static final String SJP_EVENTS_TRANSPARENCY_REPORT_GENERATION_STARTED = "sjp.events.transparency-pdf-report-generation-started";
    private static final String SJP_EVENTS_TRANSPARENCY_REPORT_METADATA_ADDED = "sjp.events.transparency-pdf-report-metadata-added";
    ...
    @Test
    public void shouldGenerateTransparencyPDFReports() throws IOException {
        ...
        final EventListener eventListener = new EventListener()
                ...
                .subscribe(
                        SJP_EVENTS_TRANSPARENCY_REPORT_REQUESTED,
                        SJP_EVENTS_TRANSPARENCY_REPORT_GENERATION_STARTED
                )
                .run(() -> transparencyReportHelper.requestToGenerateTransparencyReport(payload));
        ...
        final Optional<JsonEnvelope> transparencyReportStartedEvent = eventListener.popEvent(SJP_EVENTS_TRANSPARENCY_REPORT_GENERATION_STARTED);
        ...
        final String transparencyReportId = transparencyReportRequestedEvent
                .map(requestedEvent -> requestedEvent.payloadAsJsonObject().getString(TRANSPARENCY_REPORT_ID))
                .orElse("");
        ...
        final String startedTransparencyReportId = transparencyReportStartedPayload.getString(TRANSPARENCY_REPORT_ID);
        ...
        validateThePdfContent(reportContent);
    }
    ...
    public void shouldGenerateTransparencyJsonReports() {
        ...
        final EventListener eventListener = new EventListener()
                .withMaxWaitTime(50000)
                .subscribe(
                        SJP_EVENTS_TRANSPARENCY_REPORT_REQUESTED_JSON,
                        SJP_PUBLIC_EVENT_TRANSPARENCY_REPORT_GENERATED
                )
                .run(() -> transparencyReportHelper.requestToGenerateTransparencyReport(payload));

        final Optional<JsonEnvelope> transparencyReportRequestedEvent = eventListener.popEvent(SJP_EVENTS_TRANSPARENCY_REPORT_REQUESTED_JSON);
        final Optional<JsonEnvelope> transparencyReportStartedEvent = eventListener.popEvent(SJP_PUBLIC_EVENT_TRANSPARENCY_REPORT_GENERATED);
    ...
    @Test
    public void shouldHandleTransparencyReportFailure() {
        ...
        final EventListener generationFailedEventListener = new EventListener()
                .withMaxWaitTime(50000)
                .subscribe(SJP_EVENTS_TRANSPARENCY_REPORT_GENERATION_FAILED)
                .run(() -> SysDocGeneratorHelper.publishGenerationFailedPublicEvent(
                        fromString(transparencyReportId),
                        TEMPLATE_NAME
                ));

        final Optional<JsonEnvelope> generationFailed = generationFailedEventListener.popEvent(SJP_EVENTS_TRANSPARENCY_REPORT_GENERATION_FAILED);
