...
import static uk.gov.moj.cpp.sjp.material.client.MaterialClient.REQUEST_PARAM_ADD_INLINE_CONTENT_DISPOSITION_HEADER;
...
public class MaterialClientTest {
    ...
    @Test
    public void shouldGetMaterialWithHeader() {
        materialClient.getMaterialWithHeader(fromString(MATERIAL_ID_VALUE), fromString(USER_ID_VALUE));
        ...
        verify(webTarget).queryParam(REQUEST_PARAM_ADD_INLINE_CONTENT_DISPOSITION_HEADER, true);
