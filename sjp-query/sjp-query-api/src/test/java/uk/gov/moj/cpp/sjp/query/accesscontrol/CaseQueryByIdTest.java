...
public class CaseQueryByIdTest extends BaseDroolsAccessControlTest {

    private static final String CONTENT_TYPE = "sjp.query.case";
    ...
    public void shouldNotAllowUserNotInAuthorisedGroupToQueryCase() {
        when(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getQueryCaseActionGroups())).thenReturn(false);
    ...
    public void tearDown() {
        ...
        assertThat(listCaptor.getValue(), containsInAnyOrder(getQueryCaseActionGroups().toArray()));
