...
public class CaseSearchByMaterialIdTest extends BaseDroolsAccessControlTest {
    ...
    public void shouldAllowUserInAuthorisedGroupToSearchCasesByMaterialId() {
        given(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getQueryCasesSearchByMaterialIdActionGroups())).willReturn(true);
    ...
    public void shouldNotAllowUserNotInAuthorisedGroupToSearchCasesByMaterialId() {
        given(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getQueryCasesSearchByMaterialIdActionGroups())).willReturn(false);
    ...
    public void tearDown() {
        ...
        assertThat(listCaptor.getValue(), containsInAnyOrder(getQueryCasesSearchByMaterialIdActionGroups().toArray()));
