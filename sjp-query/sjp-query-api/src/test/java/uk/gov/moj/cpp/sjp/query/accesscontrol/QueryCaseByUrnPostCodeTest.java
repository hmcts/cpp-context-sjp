...
public class QueryCaseByUrnPostCodeTest extends BaseDroolsAccessControlTest {
    ...
    public void shouldAllowAuthorisedUserToIssueUrnPostcodeQuery() {
        given(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getQueryCaseByUrnPostcodeActionGroups())).willReturn(true);
        assertSuccessfulOutcome(executeRulesWith(action));
    }

    @Test
    public void shouldNotAllowUnauthorisedUserToIssueUrnPostcodeQuery() {
        given(userAndGroupProvider.isMemberOfAnyOfTheSuppliedGroups(action, getQueryCaseByUrnPostcodeActionGroups())).willReturn(false);
    ...
    public void tearDown() {
        ...
        assertThat(listCaptor.getValue(), containsInAnyOrder(getQueryCaseByUrnPostcodeActionGroups().toArray()));
