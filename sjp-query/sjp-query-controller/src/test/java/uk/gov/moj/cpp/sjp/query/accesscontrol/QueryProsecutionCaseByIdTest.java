...
public class QueryProsecutionCaseByIdTest extends BaseDroolsAccessControlTest {

    private static final String CONTENT_TYPE = "sjp.query.prosecution-case";

    private Action action;

    public QueryProsecutionCaseByIdTest() {
