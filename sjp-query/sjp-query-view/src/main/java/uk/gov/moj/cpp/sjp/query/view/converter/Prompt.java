...
public enum Prompt {
    ...
    FCOST_MAJOR_CREDITOR(1, fromString("2b0ca749-7ede-4446-ae59-5beec3a72143"), MajorCreditorPromptConverter::new),
    ...
    WDRNNOT_REASONS(2, fromString("3eda9fa5-9aa9-4c78-bd70-84c437d3feed"), PromptConverter::new),
    ...
    RINSTL_INSTALMENT_AMOUNT(96, fromString("a507cdea-336e-465a-9bf2-0c7bb5a3d9c7"), PromptConverter::new),
    RINSTL_PAYMENT_FREQUENCY(97, fromString("0ed44d89-51b7-451d-8b80-49678c40b1b9"), () -> new FixedListPromptConverter(FixedList.INSTALMENTS_PAYMENT_FREQUENCY)),
    RINSTL_INSTALMENT_START_DATE(98, fromString("e091af2e-43d0-495d-b3b0-432010358a45"), PromptConverter::new),
    LSUMI_INSTALMENT_AMOUNT(98, fromString("37909b32-aff3-469e-9ed2-9c5fc0aae4e7"), PromptConverter::new),
    ...
    LSUMI_INSTALMENT_START_DATE(99, fromString("b76870fe-634b-11e8-adc0-fa7ae01bbebc"), PromptConverter::new),
    LSUMI_LUMP_SUM_AMOUNT(96, fromString("11ba492a-e2ad-11e8-9f32-f2801f1b9fd1"), PromptConverter::new),
    INSTALMENTS_AMOUNT(96, fromString("be5a912b-f198-46bb-bae6-ffd0f722c689"), PromptConverter::new),
    INSTL_PAYMENT_FREQUENCY(97, fromString("61c189f1-84b8-4d0e-a6d8-f0c2711d8139"), () -> new FixedListPromptConverter(FixedList.INSTALMENTS_PAYMENT_FREQUENCY)),
    INSTL_INSTALMENT_START_DATE(98, fromString("3dd7663e-64c5-11e8-adc0-fa7ae01bbebc"), PromptConverter::new),
    ...
    SUMRTO_DATE_OF_HEARING(5, fromString("b9e995a4-5c77-4d60-bbb4-9aefabdcc8df"), PromptConverter::new),
    SUMRTO_TIME_OF_HEARING(10, fromString("73cb4625-30dc-4bea-b8d4-380727094aa9"), PromptConverter::new),
