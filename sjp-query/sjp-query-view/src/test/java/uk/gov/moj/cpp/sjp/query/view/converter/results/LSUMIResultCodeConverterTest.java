...
public class LSUMIResultCodeConverterTest extends ResultCodeConverterTest {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void shouldConvertLumpSumInstalmentsResult(String lumpSumAmountTerminalEntry, String instalmentAmountTerminalEntry, String frequencyTerminalEntry, String startDateTerminalEntry) {
