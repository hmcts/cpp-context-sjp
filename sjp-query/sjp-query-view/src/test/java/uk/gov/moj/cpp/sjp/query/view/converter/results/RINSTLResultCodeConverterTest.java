...
public class RINSTLResultCodeConverterTest extends ResultCodeConverterTest {
    ...
    @ParameterizedTest
    @MethodSource("data")
    public void shouldConvertReserveTermInstalmentsResult(String instalmentAmountTerminalEntry, String frequencyTerminalEntry, String startDateTerminalEntry) {
