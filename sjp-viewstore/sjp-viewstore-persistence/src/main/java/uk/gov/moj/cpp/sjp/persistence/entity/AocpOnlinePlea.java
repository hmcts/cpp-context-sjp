...
@Entity
@Table(name = "aocp_online_plea")
public class AocpOnlinePlea {
    ...
    @Column(name = "aocp_accepted")
    private Boolean aocpAccepted;

    @Embedded
    private OnlinePleaPersonalDetails personalDetails;

    public AocpOnlinePlea() {
    }

    public AocpOnlinePlea(final UUID caseId ,final UUID defendantId,
                          final OnlinePleaPersonalDetails personalDetails, final ZonedDateTime submittedOn,
                          final Boolean aocpAccepted) {
        this.caseId = caseId;
    ...
    public AocpOnlinePlea(final UUID caseId, final FinancialMeansUpdated financialMeansUpdated) {
        this(caseId, financialMeansUpdated.getDefendantId(), financialMeansUpdated.getUpdatedDate());
    }

    public AocpOnlinePlea(final TrialRequested trialRequested) {
        this(trialRequested.getCaseId(), trialRequested.getUpdatedDate());
    }

    public AocpOnlinePlea(final PleaUpdated pleaUpdated) {
        this(pleaUpdated.getCaseId(), pleaUpdated.getUpdatedDate());
    }

    public AocpOnlinePlea(final PleadedGuilty pleadedGuilty) {
        this(pleadedGuilty.getCaseId(), pleadedGuilty.getPleadDate());
    }



    public AocpOnlinePlea(final PleadedGuiltyCourtHearingRequested pleadedGuiltyCourtHearingRequested) {
        this(pleadedGuiltyCourtHearingRequested.getCaseId(), pleadedGuiltyCourtHearingRequested.getPleadDate());
    }

    public AocpOnlinePlea(final PleadedNotGuilty pleadedNotGuilty) {
        this(pleadedNotGuilty.getCaseId(), pleadedNotGuilty.getPleadDate());
    }

    public AocpOnlinePlea(final InterpreterUpdatedForDefendant interpreterUpdatedForDefendant) {
        this(interpreterUpdatedForDefendant.getCaseId(), interpreterUpdatedForDefendant.getUpdatedDate());
    }

    public AocpOnlinePlea(final HearingLanguagePreferenceUpdatedForDefendant hearingLanguageUpdated) {
        this(hearingLanguageUpdated.getCaseId(), hearingLanguageUpdated.getUpdatedDate());
    }

    public AocpOnlinePlea(final DefendantDetailsUpdated defendantDetailsUpdated) {
    ...
    public AocpOnlinePlea(final OutstandingFinesUpdated outstandingFinesUpdated) {
        this(outstandingFinesUpdated.getCaseId(), outstandingFinesUpdated.getUpdatedDate());
    }

    public AocpOnlinePlea(final DefendantDetail defendantDetail, final ZonedDateTime updatedDate, final UUID id) {
        this(id, defendantDetail.getCaseDetail().getId(), defendantDetail.getId(), updatedDate);
     ...
     */
    public AocpOnlinePlea(final UUID caseId, final UUID defendantId, final OnlinePleaPersonalDetails personalDetails, final ZonedDateTime submittedOn) {
        this(caseId, submittedOn);
        this.defendantId = defendantId;
        this.personalDetails = personalDetails;
    }

    private AocpOnlinePlea(final UUID caseId, final UUID defendantId, final ZonedDateTime submittedOn) {
        this.caseId = caseId;
        this.defendantId = defendantId;
        this.submittedOn = submittedOn;
    }

    private AocpOnlinePlea(final UUID id, final UUID caseId, final UUID defendantId, final ZonedDateTime submittedOn) {
        this.id = id;
        this.caseId = caseId;
        this.defendantId = defendantId;
        this.submittedOn = submittedOn;
    ...
    private AocpOnlinePlea(final UUID caseId, final ZonedDateTime submittedOn) {
        this.caseId = caseId;
        this.submittedOn = submittedOn;
    }
    ...
    public void setAocpAccepted(final Boolean aocpAccepted) {
        this.aocpAccepted = aocpAccepted;
    }
